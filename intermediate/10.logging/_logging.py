#Python comes with a powerful built-in logging module.
 #Different log levels, different config options, how to log in different modules, how to use different log handlers,
  #how to capture stack traces in your log, how to rotate file handlers.
import logging
'''
...
# Rotating file handlers
 #if we have lots of different modules, and log many different things, esp. if you use a micro service architecture, then we'd better use JSON format for logging
  #https://github.com/mainz1011/python-json-logger     pip install it first, and then define the formatter and add it to logger
