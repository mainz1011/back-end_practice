...
# %, .format(), f-string ('f-string' is the new way of formatting)
var1 = "Tom"
...
var3 = 6.168886
var4 = 8.666666
string9 = "the variables are {:.2f} and {}".format(var3, var4)
print(string9)    #results:  the variables are 6.17 and 8.666666

var3 = 6.168886
var4 = 8.666666
string10 = f"the variables are {var3*2} and {var4}"
print(string10)   #results:  the variables are 12.337772 and 8.666666
